...
class MapsMeCheckWalkingDistanceTime(_MapsMeQuery):
  ...
  template = 'Check the walking distance and time between {origin} and {destination}'
  complexity = 2.5
...
class MapsMeCheckDrivingDistanceTime(_MapsMeQuery):
  ...
  template = 'Check the driving distance and time between {origin} and {destination}'
  complexity = 2.5
...
class MapsMeCheckRidingTime(_MapsMeQuery):
  ...
  template = 'Check the riding time between {origin} and {destination}'
  complexity = 2.5
...
class MapsMeCheckPublicTransportRoute(_MapsMeQuery):
  ...
  template = 'Check the route by public transportation between {origin} and {destination}'
  complexity = 3
...
class MapsMeCompareRidingVsPublicTransport(_MapsMeQuery):
  ...
  template = (
      'Compare which takes less time to travel between {origin} and '
...
class MapsMeCheckNearestPlace(_MapsMeQuery):
  ...
  template = 'Check the nearest {place_type} and tell me what is it'
  complexity = 2
...
class MapsMeCheckNearestPlaceWalkTime(_MapsMeQuery):
  ...
  template = (
      'Check the nearest {place_type}, and tell me the time it will take '
...
class MapsMeCheckNearestHotel(_MapsMeQuery):
  ...
  template = 'Check the nearest hotel, tell me what is it'
  complexity = 2
...
class MapsMeCheckNearestPlaceDriveTime(_MapsMeQuery):
  ...
  template = (
      'Check the nearest {place_name}, and tell me how long it will take '
...
class MapsMeAddWorkPlace(_MapsMeOperation):
  ...
  template = 'Add the address of {place_name} to my Work place'
  complexity = 3
...
class MapsMeNavigateToLocation(_MapsMeOperation):
  ...
  template = 'Navigate from my location to {destination}'
  complexity = 2
...
class MapsMeNavigateToStanford(_MapsMeOperation):
  ...
  template = 'Navigate from my location to Stanford University'
  complexity = 2
...
class MapsMeNavigateToUniversitySouth(_MapsMeOperation):
  ...
  template = 'Navigate from my location to University South'
  complexity = 2
...
class MapsMeNavigateToOpenAI(_MapsMeOperation):
  ...
  template = 'Navigate from my location to OpenAI'
  complexity = 2
...
class MapsMeNavigateToBerkeley(_MapsMeOperation):
  ...
  template = 'Navigate from my location to University of California, Berkeley'
  complexity = 2

...
#### CalculatorInput1
- **Complexity**: 1.5
- **Description**: Input the number 1 in Calculator
- **Goal**: "Input 1 in Calculator."
- **Success Criteria**: Formula display shows "1"

#### CalculatorInput1Plus1
- **Complexity**: 1.5
- **Description**: Input the expression '1+1' in Calculator
- **Goal**: "Input '1+1' in Calculator."
- **Success Criteria**: Formula display shows "1+1"

#### CalculatorInput3Times5
- **Complexity**: 1.5
- **Description**: Input the expression '3×5' in Calculator
- **Goal**: "Input '3×5' in Calculator."
- **Success Criteria**: Formula display shows "3×5"

#### CalculatorInput2Plus24Div3
- **Complexity**: 2.0
- **Description**: Input the expression '2+24÷3' in Calculator
- **Goal**: "Input '2+24÷3' in Calculator."
- **Success Criteria**: Formula display shows "2+24÷3"

#### CalculatorInput17Times23
- **Complexity**: 2.0
- **Description**: Input the expression '17×23' in Calculator
- **Goal**: "Input '17×23' in Calculator."
...
- **Complexity**: 2.0
- **Description**: Input 'cos(60)' in Calculator
- **Goal**: "Input 'cos(60)' in Calculator."
- **Success Criteria**: Formula display shows "c60" (Calculator's shorthand notation)

#### CalculatorInputCos180
- **Complexity**: 2.0
- **Description**: Input 'cos(180)' in Calculator
- **Goal**: "Input 'cos(180)' in Calculator."
- **Success Criteria**: Formula display shows "c180"

#### CalculatorInputFactorial6
- **Complexity**: 2.0
- **Description**: Input factorial of 6 in Calculator
- **Goal**: "Input factorial of 6 in Calculator."
- **Success Criteria**: Formula display shows "6!"

#### CalculatorInputSqrt25
- **Complexity**: 2.0
- **Description**: Input square root of 25 in Calculator
- **Goal**: "Input square root of 25 in Calculator."
- **Success Criteria**: Formula display shows "√25"

#### CalculatorInputLn1234
- **Complexity**: 2.0
- **Description**: Input 'ln(1234)' in Calculator
- **Goal**: "Input 'ln(1234)' in Calculator."
...
- **Complexity**: 2.5
- **Description**: Input the combination formula '5!÷(2!x3!)' in Calculator
- **Goal**: "Input '5!÷(2!x3!)' in Calculator."
- **Success Criteria**: Formula display shows "5!÷(2!×3!)"

#### CalculatorInput10Choose2
- **Complexity**: 2.5
- **Description**: Input the combination formula '10!÷(2!x8!)' in Calculator
- **Goal**: "Input '10!÷(2!x8!)' in Calculator."
...
- **Complexity**: 2.0
- **Description**: Compute 50% of 28 ('50%28') in Calculator
- **Goal**: "Compute 50% of 28 ('50%28') in Calculator."
...
- **Complexity**: 3.0
- **Description**: Compute the geometric mean of 3, 4, and 5 in Calculator
...
- **Complexity**: 3.0
- **Description**: Compute the harmonic mean of 4 and 5 in Calculator

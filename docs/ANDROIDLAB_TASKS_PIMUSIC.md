...
- **Goal**: "In Pi Music Player, tell me how many songs do I have in total?"
...
- **Goal**: "In Pi Music Player, help me check how many {artist}'s songs do I have?"
...
- **Goal**: "In Pi Music Player, what is the album name of the song {song_title}?"
...
- **Goal**: "In Pi Music Player, what is the duration time of the longest song by {artist}?"
...
- **Goal**: "In Pi Music Player, sort the songs by title in ascending order. What are the second and fourth songs?"
...
- **Goal**: "In Pi Music Player, what is the total duration time of all of {artist}'s songs?"
...
- **Goal**: "In Pi Music Player, play the first song in '{playlist_name}' playlist."
...
- **Goal**: "In Pi Music Player, sort {artist}'s songs by duration time in descending order."
...
- **Goal**: "In Pi Music Player, create a playlist named '{playlist_name}' for me."
...
- **Goal**: "In Pi Music Player, pause the currently playing song and seek to {seek_minutes} minute and {seek_seconds} seconds."
...
- **Goal**: "In Pi Music Player, play {song_title} by {artist}."
...
- **Goal**: "In Pi Music Player, sort the songs by duration time in ascending order."
